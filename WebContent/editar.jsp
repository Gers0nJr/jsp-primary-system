...
<html>
    <head>
        ...
        <div class="container">
            ...
            <form name="myform" class="form-horizontal" action="editarCadastro" method="post">
                    <div class="control-group">
                      <label class="control-label" for="inputNome">Nome Completo</label>
                      <div class="controls">
                        <input type="hidden" name="id" value="<%=dados.getId()%>"/>
                        <input type="text" name="usuario" id="inputNome" value="<%=dados.getUsuario()%>" class="form-control" required="" autofocus="" onBlur="if(this.value=='')this.value=''" onFocus="if(this.value=='')this.value='">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputNomeex">Nome de exibição</label>
                      <div class="controls">
                        <input type="text" name="nome" id="inputNomeex" value="<%=dados.getNome()%>" class="form-control" required="" autofocus="" onBlur="if(this.value=='')this.value=''" onFocus="if(this.value=='')this.value='">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputDepartamento">Departamento</label>
                      <div class="controls">
                        <input type="text" name="departamento" id="inputDepartamento" value="<%=dados.getDepartamento()%>" class="form-control" required="" autofocus="" onBlur="if(this.value=='')this.value=''" onFocus="if(this.value=='')this.value='">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputCelular">Celular</label>
                      <div class="controls">
                        <input type="text" name="ccelular" id="ccelular" value="<%=dados.getCelular()%>" class="form-control" onkeydown="celular( this )" onkeyup="celular( this )">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputTelefone">Telefone</label>
                      <div class="controls">
                          <input type="text" name="ttelefone" id="ttelefone" value="<%=dados.getTelefone()%>" class="form-control" onkeydown="telefone( this )" onkeyup="telefone( this )"/>
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputEmail_Emp">Email Empresárial</label>
                      <div class="controls">
                          <input type="email" name="email_particular" id="inputEmail_Emp" value="<%=dados.getEmail_particular()%>" class="form-control">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputEmail_Pess">Email Pessoal</label>
                      <div class="controls">
                          <input type="email" name="email_pessoal" id="inputEmail_Pess" value="<%=dados.getEmail_pessoal()%>" class="form-control">
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <button class="btn btn-info" type=button onclick="javascript:window.location.reload()">&nbsp<i class="glyphicon glyphicon-refresh"></i>&nbsp</button>
                        </span>
                        <input type="text" class="form-control" id="senha" name="senha" value="<%=dados.getSenha()%>" required="" autofocus="" onBlur="if(this.value=='')this.value=''" onFocus="if(this.value=='')this.value='">
                            <span class="input-group-btn">
                                <button class="btn btn-info" type=button value="Gerar Senha" onClick="document.myform.senha.value =
